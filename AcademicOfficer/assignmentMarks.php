...
<head>
    ...
    <title>SMS | Academic | Assignment Marks</title>
                                    ...
                                    <div class="form-group col-6 justify-content-center align-content-end d-flex container-fluid">
                                        <div class="col-12 col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2 select2-secondary" data-dropdown-css-class="select2-secondary" style="width: 100%;" id="grade" onchange="studentAssignmentDetail(value);">

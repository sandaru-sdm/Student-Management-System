...
<head>
    ...
    <title>SMS | Academic Officer | Home</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Academic Dashboard</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="home.php">Academic</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <?php
                    ...
                    $student_rs = Database::search("SELECT * FROM `student` WHERE `grade_id` = '".$_SESSION["academic"]["grade_id"]."' ");
                    ...
                    $class_rs = Database::search("SELECT * FROM `teacher_has_subject` WHERE `grade_id` = '" . $_SESSION["academic"]["grade_id"] . "' ");

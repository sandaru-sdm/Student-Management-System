...
<head>
    ...
    <title>SMS | Teacher | Sign-In</title>
...
<body>
    ...
    <div class="container-fluid vh-100 d-flex justify-content-center py-5 bg-img">
        ...
        <a href="../index.php" class="col-1 btn btn-warning d-flex align-content-center justify-content-center text-center container-fluid"><i class="bi bi-house-fill"></i></a>
            ...
            <div class="container py-5 h-100 mt-5">
                ...
                <div class="row justify-content-center align-items-center mb-3 mt-5 align-items-lg-center">
                    <div class="col-10 col-lg-10">
                        <div class="card shadow-2-strong card-registration border-3 border-dark" style="border-radius: 15px;">

                            <div class="card-body p-4">
                                <h3 class="mb-2 text-center title-3">Teacher Sign-In</h3>

                                <div class="row">

                                    <div class="col-12 mt-1">
                                        <lable class="form-label fw-bold">Username</lable>
                                        <input type="text" class="form-control" id="username2" value="<?php echo $username ?>" />
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-6 d-grid mt-4 d-flex container-fluid align-content-center">
                                        <button class="btn btn-primary col-12" onclick="signInTeacher();">Sign-In</button>
                                    </div>
            ...
            <div class="col-12 fixed-bottom d-lg-block">
                <p class="text-center fw-bold text-dark">&copy; 2022 SMS | All Right Reserved.</p>
            </div>

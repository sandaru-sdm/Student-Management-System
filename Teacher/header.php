        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item d-sm-inline-block">
                    <a href="#" class="nav-link" onclick="teacherSignOut();">Sign-Out</a>
                </li>
        ...
        <aside class="main-sidebar sidebar-dark-blue elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block"><?php echo $_SESSION["teacher"]["fname"] . " " . $_SESSION["teacher"]["lname"]; ?></a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            <a href="profile.php" class="nav-link bg-success">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            <a href="students.php" class="nav-link bg-success">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            <a href="manageAssignments.php" class="nav-link bg-success">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            <a href="manageNotes.php" class="nav-link bg-success">

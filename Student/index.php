...
<head>
    ...
    <title>SMS | Student | Sign-In</title>
                    ...
                    <div class="col-10 col-lg-10">
                        <div class="card shadow-2-strong card-registration border-3 border-dark" style="border-radius: 15px;">
                            ...
                            <div class="card-body p-4">
                                <h3 class="mb-2 text-center title-3">Student Sign-In</h3>

                                <div class="row">

                                    <div class="col-12 mt-1">
                                        <lable class="form-label fw-bold">Username</lable>
                                        <input type="text" class="form-control" id="username3" value="<?php echo $username ?>" />
                                    </div>
                                    ...
                                    <div class="col-6 mt-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="1" id="rememberme3">
                                    ...
                                    <div class="col-12 col-lg-6 d-grid mt-4 d-flex container-fluid align-content-center">
                                        <button class="btn btn-primary col-12" onclick="signInStudent();">Sign-In</button>
                                    </div>

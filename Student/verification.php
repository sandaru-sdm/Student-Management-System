...
<head>
    ...
    <title>SMS | Academic | Varification</title>
                    ...
                    <div class="col-10 col-lg-10">
                        <div class="card shadow-2-strong card-registration border-3 border-dark bg-dark" style="border-radius: 15px;">
                            ...
                            <div class="card-body p-4">
                                <h2 class="mb-2 text-center text-white">Verification</h2>

                                <div class="row">

                                    <div class="col-12 mt-1">
                                        <p class="text-white text-center fs-5 ">Please Enter the Verification Code sent with the email.</p>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-6 d-grid mt-4 d-flex container-fluid align-content-center">
                                        <button class="btn btn-primary col-12" onclick="studentVerfication();">Enter</button>
                                    </div>
